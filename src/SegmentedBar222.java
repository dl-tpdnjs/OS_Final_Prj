...
class SegmentedBar222 extends JPanel {
    ...
    public SegmentedBar222(int totalSeconds, List<int[]> highlightTimes, int lecutre_time, Color mainColor, Color highlightColor) {
