...
class TimerPanel2 extends JPanel {
    private List<SegmentedBar> segmentedBars; // SegmentedBar 객체들을 담을 리스트

    // 생성자
    public TimerPanel2(String csvFilePath) {
        ...
        try {
            ...
            for (Map.Entry<Integer, LectureData> entry : lectureDataMap.entrySet()) {
                ...
                SegmentedBar buttonBar = new SegmentedBar(lectureData.getButtonDuration(), lectureData.getHighlightTimes(), lectureData.getLectureDuration(), Color.GRAY, Color.RED);
    ...
    private Map<Integer, LectureData> readCSV(String csvFilePath) throws IOException, ParseException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            // LectureData 맵에 강의 번호를 키로 하는 LectureData 객체 추가
    ...
    private JLabel createHighlightLabel(List<int[]> highlightTimes) {
        ...
        return new JLabel(labelText.toString()); // 완성된 라벨 반환
    }
    ...
    private JLabel RealLectureTime(List<int[]> highlightTimes) {
        ...
        return new JLabel(labelTextBeforeFirstComma.toString()); // 완성된 라벨 반환
    }
